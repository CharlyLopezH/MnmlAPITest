...
namespace MinimalAPIPeliculas.Repositorios
{
    public class RepositorioPeliculas : IRepositorioPeliculas
    {
        ...
        {
            //Linea normal sólo trae los datos de la película
            //return await context.Peliculas.AsNoTracking().FirstOrDefaultAsync(p => p.Id == id);

            //Código para traer la entidad comentarios con los datos relacionados a la película
            ...
            //Nota, preparar el DTO comentarios para establecer la comunicación
        }
        ...
        //Método para asignar los géneros a una película...
